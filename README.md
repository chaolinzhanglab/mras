...
> **Note** 
While this workflow infers regulatory networks with ARACNe and uses them for RBP activity estimation by default, VIPER can also be run using regulatory networks derived using other methods. For details of how to run this step using networks produced elsewhere see the alternative workflow at https://github.com/MiqG/viper_splicing, which uses the empirically derived networks described in Anglada-Girotto et al. 202
